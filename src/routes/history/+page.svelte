...
<div class="min-h-full">
	...
	<div class="lg:pl-64 flex flex-col flex-1">
		...
		<div class="md:grid md:grid-cols-2 md:divide-x md:divide-gray-200">
			<div class="md:pr-14">
				<div class="flex items-center">
					<h1 class="flex-auto font-extrabold text-gray-900 ml-10 h-30">CALENDAR</h1>
					<h2 class="flex-auto font-semibold text-gray-900 ml-10">January 2022</h2>
					<button
						type="button"
			...
			<section class="mt-12 md:mt-0 md:pl-14">
				...
				<ol class="mt-4 space-y-1 text-sm leading-6 text-gray-500">
					...
					>
						<img src={admin} alt="" class="h-10 w-10 flex-none rounded-full" />
						<div class="flex-auto">
