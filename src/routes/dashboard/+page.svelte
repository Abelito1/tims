...
<div class="lg:pl-64 flex flex-col flex-1">
	...
	<div class="px-4 mt-6 sm:px-6 lg:px-8">
		...
		<ul role="list" class="grid grid-cols-1 gap-12 sm:gap-6 sm:grid-cols-2 xl:grid-cols-4 mt-3">
			...
			<li class="relative col-span-1 flex shadow-sm rounded-md">
				...
				>
					<div class="flex-1 px-4 py-2 text-sm truncate">
						<a href="/applicant" class="text-gray-900 font-medium hover:text-gray-600">
							APPLICANT REQUEST
						</a>
						<p class="text-gray-500">1 Request</p>
					</div>
					<div class="flex-shrink-0 pr-2">
						<button
							type="button"
			...
			<li class="relative col-span-1 flex shadow-sm rounded-md">
				...
				>
					<div class="flex-1 px-4 py-2 text-sm truncate">
						<a href="/records" class="text-gray-900 font-medium hover:text-gray-600"> RECORDS </a>
						<p class="text-gray-500">0 Record</p>
					</div>
					<div class="flex-shrink-0 pr-2">
						<button
							type="button"
			...
			<li class="relative col-span-1 flex shadow-sm rounded-md">
				...
				>
					<div class="flex-1 px-4 py-2 text-sm truncate">
						<a href="/rent" class="text-gray-900 font-medium hover:text-gray-600"> RENT REQUEST </a>
						<p class="text-gray-500">0 Files</p>
					</div>
					<div class="flex-shrink-0 pr-2">
						<button
